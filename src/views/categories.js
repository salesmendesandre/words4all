const categories = [
    ...
    },
    {
        id: 6,
        title: 'Anatomía',
        desc: 'Perfectamente podría decirse que este rosco tiene estrecha relación con la mítica serie “Érase una vez… la Vida”. ¿Qué no conoces la serie? ¡No te preocupes! Con el rosco conoceremos cuánto sabes acerca del cuerpo humano.',
    ...
    },
    {
        ...
        questions: [
            {text0:'Empieza por la letra A', character: 'A', status:'unsolved', 	answer: 'Aquiles', text:'Héroe de la guerra de Troya y uno de los principales protagonistas y más grandes guerreros de la Ilíada de Homero.'},
            {text0:'Empieza por la letra  B', character: 'B', status:'unsolved', 	answer: 'Baco', text:'Dios del vino, de la ebriedad, de los excesos, especialmente sexuales, y de la naturaleza.'},
            {text0:'Empieza por la letra  C', character: 'C', status:'unsolved', 	answer: 'Carlomagno', text:'Rey de los francos desde 768, rey nominal de los lombardos desde 774 e Imperator Romanum gubernans Imperium​ desde 800 hasta su muerte. '},
            {text0:'Empieza por la letra  D', character: 'D', status:'unsolved', 	answer: 'Diana', text:'Diosa virgen de la caza, protectora de la naturaleza y la Luna.'},
            {text0:'Empieza por la letra  E', character: 'E', status:'unsolved', 	answer: 'Evita', text:'Política y actriz argentina, primera dama de la Nación Argentina, de apellido Perón. '},
            {text0:'Empieza por la letra  F', character: 'F', status:'unsolved', 	answer: 'Fátima', text:'Hija de Mahoma.'},
            {text0:'Empieza por la letra  G', character: 'G', status:'unsolved', 	answer: 'George', text:'Nombre de pila del presidente del Gobierno de EEUU apellidado Bush.'},
            {text0:'Empieza por la letra  H', character: 'H', status:'unsolved', 	answer: 'Hércules', text:'Llevó a cabo doce grandes trabajos, llamados Los doce trabajos de Heracles y fue divinizado.'},
            {text0:'Empieza por la letra  I', character: 'I', status:'unsolved', 	answer: 'Isaac', text:'Nombre de pila del científico apellidado Newton'},
            {text0:'Empieza por la letra  J', character: 'J', status:'unsolved', 	answer: 'Juana', text:'Doncella de Orleans, ​ fue una joven campesina que es considerada una heroína de Francia por su papel durante la fase final de la Guerra de los Cien Años.'},
            {text0:'Empieza por la letra  L', character: 'L', status:'unsolved', 	answer: 'Luis', text:'Nombre de pila del llamado "Rey Sol" de Francia.'},
            {text0:'Empieza por la letra  M', character: 'M', status:'unsolved', 	answer: 'Medusa', text:'Ser mitológico femenino, que convertía en piedra a aquellos que la miraban fijamente a los ojos. '},
            {text0:'Empieza por la letra  N', character: 'N', status:'unsolved', 	answer: 'Napoleón', text:'Militar y estadista francés, general republicano durante la Revolución francesa y el Directorio, y artífice del golpe de Estado del 18 de brumario que lo convirtió en primer cónsul de la República el 11 de noviembre de 1799.'},
            {text0:'Empieza por la letra  O', character: 'O', status:'unsolved', 	answer: 'Ovidio', text:'Poeta romano. Sus obras más conocidas son Arte de amar y Las metamorfosis.'},
            {text0:'Empieza por la letra  P', character: 'P', status:'unsolved', 	answer: 'Pedro', text:'Nombre de pila del actual presidente del Gobierno de España.'},
            {text0:'Contiene la letra  Q', character: 'Q', status:'unsolved', 	answer: 'Saqueos', text:'Incursiones que realizaban los vikingos durante sus viajes a otros territorios.'},
            {text0:'Empieza por la letra  R', character: 'R', status:'unsolved', 	answer: 'Rómulo', text:'Fundador de la ciudad de Roma junto con su hermano Remo.'},
            {text0:'Empieza por la letra  S', character: 'S', status:'unsolved', 	answer: 'Sigmund', text:'Nombre de pila de psicoanalista apellidado Zeus.'},
            {text0:'Empieza por la letra  T', character: 'T', status:'unsolved', 	answer: 'Tomás', text:'Nombre de pila del patrón de la Universidad de Salamanca.'},
            {text0:'Empieza por la letra  U', character: 'U', status:'unsolved', 	answer: 'Utrecht', text:'Conjunto de tratados firmados por los estados antagonistas en la Guerra de Sucesión Española entre los años 1713 y 1715 en la ciudad neerlandesa de Utrecht y en la alemana de Rastatt.'},
            {text0:'Contiene la letra  V', character: 'V', status:'unsolved', 	answer: 'Victoria', text:'Nombre de la actual reina de Reino Unido.'},
            {text0:'Contiene la letra  W', character: 'W', status:'unsolved', 	answer: 'Washington', text:'Primer presidente de los EEUU.'},
            {text0:'Contiene la letra  X', character: 'X', status:'unsolved', 	answer: 'Beatrix', text:'Nombre la reina de Países Bajos.'},
            {text0:'Contiene la letra  Y', character: 'Y', status:'unsolved', 	answer: 'Rajoy', text:'Apellido del anterior presidente del Gobierno de España.'},
            {text0:'Empieza por la letra  Z', character: 'Z', status:'unsolved', 	answer: 'Zeus', text:'Divinidad a la que se denomina a veces con el título de «padre de los dioses y los hombres»,​ que gobierna a los dioses del Olimpo como un padre a una familia, de forma que incluso los que no eran sus hijos naturales se dirigen a él como tal.'}
        ]
    }
